...
#delivery failure: email: MAILER-DAEMON@us-west-2.amazonses.com
#report spam: complaints@us-west-2.email-abuse.amazonses.com
#spam email: EMAIL (YOUR ATTRIBUTES)
...
class Api::V1::HooksController < ActionController::API
  ...
  def process_email_notification(message) 
    ...
    if ["mailer-daemon@us-west-2.amazonses.com", "complaints@us-west-2.email-abuse.amazonses.com"].include?(from_address)
      #SnsReceiverJob is marking it as bounced or spam
      return nil
    end
