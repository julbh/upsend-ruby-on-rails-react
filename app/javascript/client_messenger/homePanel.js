...
import icon_chat from "../../assets/images/chat.svg";
            ...
            <CardContent>
              ...
              <CardButtonsGroup>
                ...
                { /*
                  ...
                  </AnchorButton>start_conversation
                */ }


                <AnchorButton href="#" onClick={displayNewConversation} style={{padding: 0, paddingLeft: 30, width: 200, height: 50, margin: 0}}>
        ...
        shouldDisplayArticles() &&
          <Card in={transition}>
            ...
            <ButtonWrapper>
              ...
              /> 
              <button onClick={()=> searchArticles(textInput.value)} style={{ padding:"11px", borderRadius:"6px"}}>
                {<img style={{width:"15px", marginTop:"3px"}} src="data:image/png;base64,"/> }
              </button>
            </ButtonWrapper>
          </Card>
      }
