...
class ConversationContainerShow extends Component {
  ...
  render() {
    const participant = this.props.conversation.mainParticipant ? this.props.conversation.mainParticipant : null;
    return (
              ...
              <HeaderTitle>
                ...
                <span>
                  {this.props.conversation.mainParticipant ? (
                    <b style={{fontSize: 18}}>{this.props.conversation.mainParticipant.displayName}</b>
                  ) : null}
                </span>
              </HeaderTitle>
                        ...
                        {o.appUser && (
                          ...
                          >
                            <div className='avatarContainer'>
                              {
                                (!isReplied && this.props.conversation.mainParticipant.id !== o.appUser.id) &&
