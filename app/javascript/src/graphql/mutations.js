...
export const TEST_CAMPAIGN = `
  mutation TestCampaign($appKey: String!, $id: Int!, $toEmails: String!, $template: String!, $includeUnsubscriptionLink: Boolean!, $footerAddress: String!, $helpEmail: String!, $helpContact: String!){
    campaignTest(appKey: $appKey, id: $id, toEmails: $toEmails, template: $template, includeUnsubscriptionLink: $includeUnsubscriptionLink, footerAddress: $footerAddress, helpEmail: $helpEmail, helpContact: $helpContact){
      errors
      campaign {
        name
        id
