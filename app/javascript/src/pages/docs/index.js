...
function CustomizedInputBase({lang, history, domain}) {
  ...
  function handleClick(article){
    history.push(`/${domain}/${lang}/articles/${article.slug}`)
    handleClose();
  }
...
export default function MainLAyout(){
  return (
    ...
    <BrowserRouter>
      <Switch> 
        <Route path={"/:domain/:lang?(en|es)?"} render={(props)=>(
          <Docs {...props}/>
        )}/>
...
function Docs(props) {
  ...
  const [domain, setDomain] = React.useState(props.match.params.domain)
                ...
                <div className={classes.heroContent} 
                  ...
                  <Container maxWidth="md">
                    ...
                    <Grid 
                      ...
                      { <Route render={(props)=>(
                        <CustomizedInputBase domain={domain} lang={lang} {...props}/>
                      )}></Route> }
...

                {
                  ...
                  <Switch>
                      ...
                      <Route exact path={`${props.match.url}/articles/:id`} render={(props)=>(
                        <Article {...props} lang={lang} theme={newDanteTheme} domain={domain} />
                      )}/>

                      <Route exact path={`${props.match.url}/collections/:id`} render={(props)=>(
                        <CollectionsWithSections {...props} lang={lang} domain={domain}/>
                      )}/>

                      <Route exact path={`${props.match.url}`} render={(props)=>(
                        <Collections {...props} lang={lang} domain={domain} />
                      )}
                      />
...

        {
          ...
          <Paper className={classes.articlePaper}>
            ...
            <Breadcrumbs aria-label="Breadcrumb">
              ...
              <LinkRouter className={classes.breacrumbLink} to={`/${domain}/${lang}`}>
                Collections
              </LinkRouter>

              {
                article.collection ?
                  <LinkRouter className={classes.breacrumbLink} to={`/${domain}/${lang}/collections/${article.collection.slug}`}>
                        ...
                        <Card className={classes.card}>
                          ...
                          */}
                          ...
                          <CardContent className={classes.cardContent}>
                            ...
                            <RouterLink 
                              color={'primary'}
                              to={`${match.url}/collections/${card.slug}`}> 
...
function CollectionsWithSections({match, lang, domain}){
                        ...
                        <ListItem divider key={`articles-${article.id}`}>
                          <ListItemText primary={
                            <div>
                              <RouterLink 
                                color={'primary'}
                                to={`/${domain}/${lang}/articles/${article.slug}`}>
                                {article.title}
                              </RouterLink>
