  ...
  inviteButton = () => {
    return (
      <React.Fragment>
        ...
        <UpgradeDialog isOpen={this.state.showUpgradeDialog} handleClose={this.closeUpgradeDialog} messageContext='addTeamMember' />
        <Button
          variant="contained"
          color="primary" 
          className={this.props.classes.addUser}  
          onClick={this.state.requiresUpgrade ? this.openUpgradeDialog : this.open}
        >
          Add user
        </Button>
      </React.Fragment>
      ...
      { appKey: this.props.app.key },
      {
        success: (data) => {
          this.setState({
            ...
            loading: false,
            requiresUpgrade: data.app.upgradeToAddAgents
          });
        },
        error: () => {},
      }
