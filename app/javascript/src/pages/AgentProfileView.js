                ...
                <Typography variant={"h5"}>
                {
                  ...
                  { this.state.completed > 0 ?
                    <div style={{marginTop: "10px"}}>
                      <LinearProgress variant="determinate" value={this.state.completed} color="primary" />
                    </div>
                  : '' }
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} sm={4}>
              { 
                ...
                <UserDataContent style={{width: "100%"}}>
                  <Accordeon items = {[
                    {
                        name: "Public Profile",
                        component: null,
                    ...
                    },
                    {
                        ...
                        items: [{
                          label: "Created at:",
                          value: <Moment utc fromNow>{this.props.currentUser.createdAt}</Moment>
                        },
                        {
                          label: "Email:",
