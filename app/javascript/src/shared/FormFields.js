...
class FieldRenderer extends React.Component {
  ...
  fieldRenderer = () => {
    ...
    const {namespace, data, props, errors, classes, errorNamespace, buttonClass} = this.props
    ...
    switch (data.type) {
      ...
      case "bool": 
        ...
        return <div>
                <FormControlLabel 
                  ...
                  control={
                      <Checkbox 
                        defaultChecked={props.data[data.name] || props.data[camelCase(data.name)]} 
                        name={`${namespace}[${data.name}]`} 
                        value={true} 
                      />
                  }
      ...
      case "upload":
      {
          return <div className={classes.upload} style={data.rowImage} >
              <input
                  accept="image/*"
                  style={{display: 'none'}}
              ...
              />
              {
                  (data.imgStyle) ? <div style={data.imgStyle}>
                      <img src={props.data[camelCase(data.name)]}/>
                  </div> : <img src={props.data[camelCase(data.name)]}/>
              }

              <label htmlFor={data.name}>
                  <Button variant="contained" component="span" classes={{root: buttonClass}}
