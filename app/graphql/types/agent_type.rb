...
module Types
  class AgentType < Types::BaseObject
    ...
    def last_sign_in_at
      object.last_sign_in_at.present? ? object.last_sign_in_at.to_date.iso8601 : ""
    end

    def invitation_accepted_at
      object.invitation_accepted_at.present? ? object.invitation_accepted_at.to_date.iso8601 : ""
    end

    def invitation_sent_at
      object.invitation_sent_at.present? ? object.invitation_sent_at.to_date.iso8601 : ""
    end
