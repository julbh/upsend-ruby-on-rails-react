...
module Types
  class AppUserType < Types::BaseObject
    ...
    field :signed_up, String, null: true
    field :created_at, String, null: true
    field :last_contacted, String, null: true
    field :last_heard_from, String, null: true
    ...
    def first_seen
      object.first_seen.present? ? object.first_seen.to_date.iso8601 : ""
    end

    def last_seen
      object.last_seen.present? ? object.last_seen.to_date.iso8601 : ""
    end

    def last_visited_at
      object.last_visited_at.present? ? object.last_visited_at.to_date.iso8601 : ""
    end
