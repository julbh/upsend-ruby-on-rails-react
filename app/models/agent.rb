...
class Agent < ApplicationRecord
  ...
  devise  :invitable,
          ...
          :rememberable,
          :validatable,
          :omniauthable, omniauth_providers: %i[doorkeeper google_oauth2 linkedin]
  ...
  def self.invite_agent(email, app)
    agent = Agent.invite!(email: email){|a| a.skip_invitation = true } 
