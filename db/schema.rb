...
ActiveRecord::Schema.define(version: 2020_06_20_131202) do
  ...
  create_table "intercom_imports", force: :cascade do |t|
    t.integer "app_id"
    t.integer "agent_id"
    t.integer "app_package_integration_id"
    t.string "name"
    t.string "token"
